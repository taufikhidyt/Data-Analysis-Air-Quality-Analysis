...
df = pd.read_csv('C:\\Users\\asus\\Downloads\\Dicoding\\Air-quality-analysis\\dashboard\\all_df.csv')
...
tab1, tab2, tab3, tab4 = st.tabs(["📈 Fluktuasi Konsentrasi Polutan", "📊 Hubungan antar Polutan", "🏭 Rata-rata Konsentrasi PM2.5 per Stasiun", "🏭 Rata-rata Konsentrasi PM10 per Stasiun"])
